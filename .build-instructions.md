...
"Cambia el color del botón principal de "Reservar Cita" a verde brillante (#5de05d). Si no existe ese botón, agrega uno en el hero con ese color."
...
- Run: npm run build
- If it passes: commit all changed files with message "change: Cambia el color del botón principal de "Reservar Cita" a ver" and push
